    ...
    <main className="flex min-h-screen flex-col items-center justify-between">
        ...
        >
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <Link
              ...
              className="rounded-full bg-brand-primary px-8 py-4 text-sm font-semibold text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 transition-all duration-300 hover:scale-105"
            >
        ...
        <div className="mx-auto max-w-7xl">
          ...
          >
            <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-12 lg:max-w-none lg:grid-cols-4">
              {/* Service 1 */}
              <motion.div variants={itemVariants} className="flex flex-col bg-zinc-950 p-8 rounded-3xl border border-zinc-800 hover:border-brand-primary/50 transition-colors group">
      ...
      <section id="portfolio" className="w-full py-32 bg-zinc-950 px-6 lg:px-8 border-t border-zinc-900 overflow-hidden">
        <div className="mx-auto max-w-7xl">
          ...
          >
            {/* Project 1 */}
            <motion.div variants={itemVariants} className="group relative aspect-[4/3] overflow-hidden rounded-2xl bg-zinc-900 border border-zinc-800">
      ...
      <section className="w-full py-24 bg-zinc-900 border-t border-zinc-800 overflow-hidden relative">
        ...
        <div className="relative flex overflow-x-hidden w-full group">
          <div className="absolute left-0 top-0 bottom-0 w-32 bg-gradient-to-r from-zinc-900 to-transparent z-10"></div>
          <div className="absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-zinc-900 to-transparent z-10"></div>
          
          <div className="animate-marquee flex gap-6 whitespace-nowrap py-4 min-w-max group-hover:[animation-play-state:paused]">
            {[1, 2].map((loop) => (
              <div key={loop} className="flex gap-6">
                {[
                  { text: "COzuna created a beautiful website for our restaurant and handled all our printed menus. The quality is unmatched!", author: "La Casa Del Mofongo MD", role: "Restaurant" },
                  { text: "They completely transformed our brand identity. Our customers constantly compliment our new look.", author: "Monica Nails Spa", role: "Local Business" },
                  { text: "Fast turnaround and incredible attention to detail on our signage and business cards.", author: "Crossway Driving School", role: "Driving School" },
                  { text: "Highly professional web design services. They really understood our vision and brought it to life.", author: "City Shields NY", role: "Security Firm" }
                ].map((item, idx) => (
                  <div key={idx} className="w-96 flex-none bg-zinc-950 p-8 rounded-2xl border border-zinc-800 whitespace-normal">
      ...
      <section className="w-full relative isolate overflow-hidden bg-brand-dark px-6 py-32 lg:px-8 border-t border-zinc-900">
        ...
        >
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <Link
              href="/get-a-quote"
              className="rounded-full bg-white px-10 py-5 text-sm font-bold text-brand-dark shadow-sm hover:bg-zinc-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 transition-all duration-300 hover:scale-105"
            >
              Start Your Project
            </Link>
          </div>

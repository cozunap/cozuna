      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          {posts.map((post: any) => {
            ...
            return (
            <article key={post.slug} className="relative flex flex-col items-start justify-between bg-zinc-900 p-8 rounded-3xl border border-zinc-800 hover:border-brand-primary/50 transition-colors group cursor-pointer">
              ...
              <div className="mt-3 w-full">
                <h3 className="text-xl font-semibold leading-6 text-white group-hover:text-brand-primary transition-colors">

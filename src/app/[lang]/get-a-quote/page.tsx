...
export default function GetAQuotePage() {
  ...
  return (
    <main className="flex min-h-screen flex-col bg-zinc-950">
      {/* Header */}
      <section className="relative py-24 px-6 lg:px-8 border-b border-zinc-900 bg-brand-dark overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl text-center">
          ...
          <motion.p 
            ...
            className="mt-6 text-xl leading-8 text-zinc-300 max-w-2xl mx-auto font-light"
          >
            Let's build something amazing together. Complete the steps below to request a personalized quote.
          </motion.p>
        </div>
      </section>
